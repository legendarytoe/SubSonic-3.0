...
{
    public partial class SSLockingTestDbDB : IQuerySurface
    {
        ...
        public SSLockingTestDbDB() 
        {
            if (DefaultDataProvider == null) {
                DataProvider = ProviderFactory.GetProvider("SSLockingTestDb");
            }
            else {
        ...
        public SSLockingTestDbDB(string connectionStringName)
        {
            DataProvider = ProviderFactory.GetProvider(connectionStringName);
            Init();
        }

		public SSLockingTestDbDB(string connectionString, string providerName)
        {
        ...
        public Query<LockingTest> LockingTests { get; set; }
        ...
        void Init()
        {
            ...
            #region ' Query Defs '
            LockingTests = new Query<LockingTest>(provider);
            #endregion
			...
			{
            	DataProvider.Schema.Tables.Add(new LockingTestTable(DataProvider));
            }
            #endregion
        }
